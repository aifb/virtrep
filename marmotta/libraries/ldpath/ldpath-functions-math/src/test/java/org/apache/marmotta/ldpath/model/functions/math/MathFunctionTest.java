...
public class MathFunctionTest extends AbstractTestBase {
    ...
    public void testMin() throws ParseException {
        ...
        final LdPathParser_cc<Value> intParser = createParserFromString("fn:min(<" + iProp.stringValue() + ">) :: xsd:int");
        ...
        final LdPathParser_cc<Value> longParser = createParserFromString("fn:min(<" + lProp.stringValue() + ">) :: xsd:long");
        ...
        final LdPathParser_cc<Value> floatParser = createParserFromString("fn:min(<" + fProp.stringValue() + ">) :: xsd:float");
        ...
        final LdPathParser_cc<Value> doubleParser = createParserFromString("fn:min(<" + dProp.stringValue() + ">) :: xsd:double");
    ...
    public void testMax() throws ParseException {
        ...
        final LdPathParser_cc<Value> intParser = createParserFromString("fn:max(<" + iProp.stringValue() + ">) :: xsd:int");
        final FieldMapping<Object, Value> intRule = intParser.parseRule(NSS);
        final Collection<Object> intResult = intRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> longParser = createParserFromString("fn:max(<" + lProp.stringValue() + ">) :: xsd:long");
        final FieldMapping<Object, Value> longRule = longParser.parseRule(NSS);
        final Collection<Object> longResult = longRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> floatParser = createParserFromString("fn:max(<" + fProp.stringValue() + ">) :: xsd:float");
        final FieldMapping<Object, Value> floatRule = floatParser.parseRule(NSS);
        final Collection<Object> floatResult = floatRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> doubleParser = createParserFromString("fn:max(<" + dProp.stringValue() + ">) :: xsd:double");
        final FieldMapping<Object, Value> doubleRule = doubleParser.parseRule(NSS);
        final Collection<Object> doubleResult = doubleRule.getValues(backend, subject);
    ...
    public void testRound() throws ParseException {
        ...
        final LdPathParser_cc<Value> floatParser = createParserFromString("fn:round(<" + fProp.stringValue() + ">) :: xsd:int");
        final FieldMapping<Object, Value> floatRule = floatParser.parseRule(NSS);
        final Collection<Object> floatResult = floatRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> doubleParser = createParserFromString("fn:round(<" + dProp.stringValue() + ">) :: xsd:long");
        final FieldMapping<Object, Value> doubleRule = doubleParser.parseRule(NSS);
        final Collection<Object> doubleResult = doubleRule.getValues(backend, subject);
    ...
    public void testSum() throws ParseException {
        ...
        final LdPathParser_cc<Value> intParser = createParserFromString("fn:sum(<" + iProp.stringValue() + ">) :: xsd:int");
        final FieldMapping<Object, Value> intRule = intParser.parseRule(NSS);
        final Collection<Object> intResult = intRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> longParser = createParserFromString("fn:sum(<" + lProp.stringValue() + ">) :: xsd:long");
        final FieldMapping<Object, Value> longRule = longParser.parseRule(NSS);
        final Collection<Object> longResult = longRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> floatParser = createParserFromString("fn:sum(<" + fProp.stringValue() + ">) :: xsd:float");
        final FieldMapping<Object, Value> floatRule = floatParser.parseRule(NSS);
        final Collection<Object> floatResult = floatRule.getValues(backend, subject);
        ...
        final LdPathParser_cc<Value> doubleParser = createParserFromString("fn:sum(<" + dProp.stringValue() + ">) :: xsd:double");
        final FieldMapping<Object, Value> doubleRule = doubleParser.parseRule(NSS);
        final Collection<Object> doubleResult = doubleRule.getValues(backend, subject);
