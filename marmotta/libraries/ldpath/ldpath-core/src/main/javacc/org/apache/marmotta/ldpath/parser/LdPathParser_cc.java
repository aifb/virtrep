...
public class LdPathParser_cc<Node> implements LdPathParserConstants {
        ...
        public LdPathParser_cc(NodeBackend<Node> backend, Reader in) {
            this(backend,null,in);
        }

        public LdPathParser_cc(NodeBackend<Node> backend, Configuration config, Reader in) {
            this(in);
        ...
        public LdPathParser_cc(NodeBackend<Node> backend, InputStream in) {
            this(backend,null,in);
        }

        public LdPathParser_cc(NodeBackend<Node> backend, Configuration config, InputStream in) {
            this(in);
            this.backend = backend;
            if(config == null) {
                this.config = new DefaultConfiguration();
        ...
        public LdPathParser_cc(NodeBackend<Node> backend, InputStream in, String encoding) {
            this(backend,null,in,encoding);
        }

        public LdPathParser_cc(NodeBackend<Node> backend, Configuration config, InputStream in, String encoding) {
            this(in,encoding);
            this.backend = backend;
            if(config == null) {
                this.config = new DefaultConfiguration();
 ...
 */
  ...
  public LdPathParser_cc(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public LdPathParser_cc(java.io.InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public LdPathParser_cc(java.io.Reader stream) {
  ...
  public LdPathParser_cc(LdPathParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
