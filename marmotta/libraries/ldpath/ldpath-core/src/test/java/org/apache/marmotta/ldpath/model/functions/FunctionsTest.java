...
public class FunctionsTest extends AbstractTestBase {
    ...
    public void testConcat() throws ParseException {
        ...
        LdPathParser_cc<Value> parser = createParserFromString("fn:concat(foo:title, \" \", foo:subtitle) :: xsd:string; ");
    ...
    public void testFirst() throws ParseException {
        ...
        LdPathParser_cc<Value> parser = createParserFromString("fn:first(foo:not_valid, foo:title, foo:subtitle, foo:not_valid2) :: xsd:string; ");
        final FieldMapping<Object, Value> field = parser.parseRule(NSS);
    ...
    public void testFirst2() throws ParseException {
        ...
        LdPathParser_cc<Value> parser = createParserFromString("fn:first(foo:i) :: xsd:int; ");
        final FieldMapping<Object, Value> field = parser.parseRule(NSS);
    ...
    public void testLast() throws ParseException {
        ...
        LdPathParser_cc<Value> parser = createParserFromString("fn:last(foo:not_valid, foo:title, foo:subtitle, foo:not_valid2) :: xsd:string; ");
        final FieldMapping<Object, Value> field = parser.parseRule(NSS);
    ...
    public void testLast2() throws ParseException {
        ...
        LdPathParser_cc<Value> parser = createParserFromString("fn:last(foo:i, ex:not_here) :: xsd:int; ");
        final FieldMapping<Object, Value> field = parser.parseRule(NSS);
    ...
    public void testEq() throws ParseException {
        ...
        final LdPathParser_cc<Value> parser = createParserFromString("ex:hasItem[fn:eq(foo:i, foo:j)]");
        ...
        final LdPathParser_cc<Value> parseri = createParserFromString("ex:hasItem[! fn:eq(foo:i, foo:j)]");
